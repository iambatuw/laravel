...
<body oncontextmenu="return false;">
    ...
    <div class="tv-container">
        <header class="top-banner">
            ...
            <div class="clock-display">
                ...
                <div class="date-text">
                    <span id="liveDate"><?php echo e($today->translatedFormat('d F Y')); ?></span>
                    <span class="opacity-25 mx-3">|</span>
                    <span class="text-white fw-bold"><?php echo e($schedule->day_of_week ?? $today->translatedFormat('l')); ?></span>
                </div>
            </div>
        </header>
        ...
        <main class="periods-grid">
            ...
            <?php $__currentLoopData = $periods; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $id => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="board-card">
                    <div class="board-card-header <?php echo e($item['cls']); ?>">
                        <div class="header-label">
                            <i class="bi <?php echo e($item['icon']); ?>"></i>
                            <h2><?php echo e($item['label']); ?></h2>
                        </div>
                        <div class="time-pill"><?php echo e($item['time']); ?></div>
                    </div>
                    <div class="scrollable-body">
                        <?php if($grouped->has($id)): ?>
                            <table class="duty-table">
                                <tbody>
                                    <?php $__currentLoopData = $grouped[$id]->sortBy('location.name'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $assign): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            <td class="teacher-cell">
                                                <span class="name">
                                                    ...
                                                    <?php endif; ?>
                                                    <?php echo e($assign->teacher->name); ?>

                                                </span>
                                                <div class="meta">
                                                    <i class="bi bi-bookmark-fill" style="font-size: 8px;"></i>
                                                    <?php echo e($assign->teacher->branch); ?>

                                                </div>
                                            </td>
                                            <td class="location-column">
                                                <span class="location-text"><?php echo e($assign->location->name); ?></span>
                                                <small class="text-white-50 d-block mt-1" style="font-size: 11px;"><?php echo e($assign->location->branch ?? ''); ?></small>
                                            </td>
                                            <td class="text-end pe-4">
                                                <div class="text-white-50 fw-black" style="font-size: 11px; letter-spacing: 0.5px;">
                                                    <i class="bi bi-layers me-1 opacity-50"></i><?php echo e($assign->location->floor ?? 'ZM'); ?>
    ...
    <div class="ticker-bar">
        📢 ÖNEMLİ: Nöbet değişim taleplerinizi sistem üzerinden öğretmen panelinden yapabilirsiniz. • İyi dersler dileriz.
    </div>
...
<?php /**PATH C:\Users\batuh\OneDrive\Masaüstü\laravel\resources\views/public/board.blade.php ENDPATH**/ ?>