...
<body>
    <div class="error-container">
        ...
        <p class="error-text">Aradığınız sayfa mevcut değil veya taşınmış olabilir.</p>
        <a href="<?php echo e(url('/dashboard')); ?>" class="error-btn">Ana Sayfaya Dön</a>
    </div>
</body>
</html>
<?php /**PATH C:\Users\batuh\OneDrive\Masaüstü\laravel\resources\views/errors/404.blade.php ENDPATH**/ ?>